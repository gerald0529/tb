  ...
  <!-- Page Head -->
    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
        <!-- <h3>Content box</h3> -->
        <h3><a href="javascript:window.history.back(-1);">返回上一页</a></h3> 
        <ul class="content-box-tabs">
          <li><a href="#tab1" class="default-tab">基本属性</a></li>
          <!-- href must be unique and match the id of target div -->
          <li><a href="#tab2" class="">图集</a></li>
          <li><a href="#tab3" class="">其他设置</a></li>
        </ul>
        <div class="clear"></div>
      </div>
 ...
 <form action="<?php echo ($act); ?>" method="post" enctype="multipart/form-data"> 
        <!-- End #tab1 -->
         ...
         <!--  <form action="<?php echo ($act); ?>" method="post" enctype="multipart/form-data"> -->
            ...
            <input class="text-input small-input" type="hidden" id="small-input" name="resource" value="<?php echo ($_SESSION["admin"]); ?>"/>
            <p>
            ...
            <p>
              ...
              <span>审核中</span>
              <input  type="radio" id="small-input" name="verifystate" value="1" <?php if($arr['verifystate'] != 2 ) echo 'checked="checked"';?>/>
              <span>通过</span>
            </p>
            <p>
              上传图片：
        ...
        <p>图集：[+][-]
        <input class="text-input small-input" type="file" id="small-input" name="thumb3" value=""/>
        <?php if(!empty($arr['thumb3'])):?>
              <br>   
              <img src="http://localhost/tb//<?php echo ($arr["thumb3"]); ?>">
          <?php endif;?>
        </p>
        </div>
        <!-- End #tab2 -->
        ...
        <p>跳转地址：
        <input class="text-input small-input" type="text" id="small-input" name="jump_url" value="<?php echo ($arr["jump_url"]); ?>"/>
        </p>
        </div>
        <!-- End #tab3 -->
        <div class="btn_wrap">
    ...
    <style type="text/css">
      .btn_wrap{ position:fixed;bottom: 0;right:30px;width: 78.5%;z-index: 5;}
            .btn_wrap .bp2{padding: 10px 20px 10px;border-top: 1px solid #d8d8d8;background: #d8d8d8;}
