          ...
          <table>
           ...
           <?php if(is_array($arr)): foreach($arr as $k=>$vo): ?><tr>
               ...
               <!--  <td><?php echo ($vo["pid"]); ?></td> -->
                ...
                <td><?php echo ($vo["tt"]); echo ($vo["title"]); ?></td>
                ...
                <td>
                  <!-- Icons -->
                  <a href="/tb/index.php/Admin/Auth/edit/id/<?php echo ($vo["id"]); ?>" title="Edit"><img src="Public/Admin//resources/images/icons/pencil.png" alt="Edit" />
                  </a> &nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="/tb/index.php/Admin/Auth/delete/id/<?php echo ($vo["id"]); ?>" title="Delete"><img src="Public/Admin//resources/images/icons/cross.png" alt="Delete" />
                  </a> 
