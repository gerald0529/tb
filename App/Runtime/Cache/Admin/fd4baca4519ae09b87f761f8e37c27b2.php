        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
           ...
           <?php if(is_array($arr)): foreach($arr as $k=>$vo): ?><tr>
                ...
                <td><a href="/tb/index.php/Admin/Category/edit/cid/<?php echo ($vo["cid"]); ?>" ><?php echo ($vo["name"]); ?></a></td>
                <td><?php echo ($vo["pid"]); ?></td>
                <td> <?php echo ($vo["is_show"]); ?></td>
                <td><?php echo ($vo["remark"]); ?></td>
                <td>
                  <!-- Icons -->
                  <a href="/tb/index.php/Admin/Category/edit/cid/<?php echo ($vo["cid"]); ?>" title="Edit"><img src="Public/Admin//resources/images/icons/pencil.png" alt="Edit" />
                  </a> &nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="/tb/index.php/Admin/Category/delete/cid/<?php echo ($vo["cid"]); ?>" title="Delete"><img src="Public/Admin//resources/images/icons/cross.png" alt="Delete" />
                  </a> 
