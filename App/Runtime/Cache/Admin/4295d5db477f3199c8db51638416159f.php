        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
           ...
           <?php if(is_array($arr)): foreach($arr as $k=>$vo): ?><tr>
                ...
                <td>
                  <!-- Icons -->
                  <a href="/tb/index.php/Admin/User/edit/uid/<?php echo ($vo["uid"]); ?>" title="Edit"><img src="Public/Admin//resources/images/icons/pencil.png" alt="Edit" />
                  </a> &nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="/tb/index.php/Admin/User/delete/uid/<?php echo ($vo["uid"]); ?>" title="Delete"><img src="Public/Admin//resources/images/icons/cross.png" alt="Delete" />
                  </a> 
