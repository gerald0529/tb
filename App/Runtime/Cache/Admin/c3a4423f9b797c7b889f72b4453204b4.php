        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
           ...
           <?php if(is_array($arr)): foreach($arr as $k=>$vo): ?><tr>
                ...
                <td><?php echo ($vo["psid"]); ?></td>
                <td> <?php echo ($vo["position_name"]); ?></td>
                <td><?php echo ($vo["width"]); ?></td>
                <td><?php echo ($vo["height"]); ?></td>
                <td>
                  <!-- Icons -->
                  <a href="/tb/index.php/Admin/Position/edit/id/<?php echo ($vo["psid"]); ?>" title="Edit"><img src="Public/Admin//resources/images/icons/pencil.png" alt="Edit" />
                  </a> &nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="/tb/index.php/Admin/Position/del/id/<?php echo ($vo["psid"]); ?>" title="Delete"><img src="Public/Admin//resources/images/icons/cross.png" alt="Delete" />
                  </a> 
