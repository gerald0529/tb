        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
           ...
           <?php if(is_array($arr)): foreach($arr as $k=>$vo): ?><tr>
               ...
               <!--  <td><a href="/tb/index.php/Admin/Ad/edit/id/<?php echo ($vo["aid"]); ?>"  ><?php echo ($vo["pic"]); ?></a></td>  -->
                <td><a href="/tb/index.php/Admin/Ad/edit/id/<?php echo ($vo["aid"]); ?>" >
                ...
                <td>
                  <!-- Icons -->
                  <a href="/tb/index.php/Admin/Ad/edit/id/<?php echo ($vo["aid"]); ?>" title="Edit"><img src="Public/Admin//resources/images/icons/pencil.png" alt="Edit" />
                  </a> &nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="/tb/index.php/Admin/Ad/delete/id/<?php echo ($vo["aid"]); ?>" title="Delete"><img src="Public/Admin//resources/images/icons/cross.png" alt="Delete" />
                  </a> 
