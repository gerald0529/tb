...
一種不悔而更勝於『法律』或『書面契約』之精神層次的約定。
            ...
            <div class="main">
                <div class="boxs">
                    <div class="ml l">
                        ...
                        <div class="pa">
                            <ul class="subnav">
                                <li ><a href="/tb/index.php/Home/Contact/index">联系我们</a></li>
                                <li class="on"><a href="/tb/index.php/Home/Contact/feedback">在线留言</a></li>
                            </ul>
                                <div class="ads">
        ...
        <div class="rel">
            <a href="javascript:pop();"><img src="Public/Home/images/1.jpg" alt=""><span></span></a>
                    ...
                    <div class="mr r">
                        <div class="t2"><h3>在线留言</h3></div>
                        <div class="a_scroll">
                            <dl class="feedback rel">
                            <form action="<?php echo U('Contact/feedback');?>" method="post">
                                <dt>主题</dt><dd><input type="text" name="theme" id="" class="inp"></dd>
                                <!-- <dt>姓名</dt><dd><input type="text" name="people" id="" class="inp"></dd> -->
                                <dt>联系电话</dt><dd><input type="text" name="tel" id="" class="inp"></dd>
                                <dt>留言內容</dt><dd>
                                    <textarea name="body" id="" cols="30" rows="10"></textarea>
                                </dd>
                                <dt>验证码</dt><dd>
                                    <input type="text" name="verify" id="" class="inp">
                                    <a href="javascript:;"   onclick="this.src+='#'"">
                                    <img src="<?php echo U('User/verify');?>" width="89" height="19" alt="">
                                    </a>
                                </dd> 
                                <dd><input type="submit" value="提交留言" class="mit">
                                <input type="reset" value="重置" class="reset"></dd>
                            </form>
                            </dl>
                        </div>
                    </div>
