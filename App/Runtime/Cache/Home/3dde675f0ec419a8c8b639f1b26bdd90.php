...
<body >
            ...
            <div class="main">
                <div class="boxs">
                    <div class="ml l">
                        ...
                        <div class="pa">
                            <ul class="subnav">
                                 <?php if(is_array($infoclass)): foreach($infoclass as $key=>$vo): ?><li <?php if($vo['index'] == 'on'): ?>class="on"<?php endif; ?>><a href="/tb/index.php/Home/About/index/cid/<?php echo ($vo["cid"]); ?>"><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; ?>
                            </ul>
                            <!-- <div class="ads">
        ...
        <div class="rel">
            <a href="javascript:pop();"><img src="Public/Home/images/1.jpg" alt=""><span></span></a>
                    ...
                    <div class="mr r">
                        ...
                        <div class="a_scroll">
                            <div class="apic">
                                <img src="<?php echo ($arr["image"]); ?>" alt="暂无图片">
                            </div>
                            <div class="cont">
                                <?php echo ($arr["body"]); ?>
                            </div>
 ...
 <script type="text/javascript">
            $(function () {
                ...
                //$(".main").css("height",winH - aboxH - bboxH - cboxH - dboxH - 55 + '100px');
